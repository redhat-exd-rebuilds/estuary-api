...
@pytest.mark.parametrize('resource,uid,reverse,expected', [
    ('advisory', '27825', False, {
        ...
        'meta': {
            'siblings_table_header': 'KojiBuilds attached Advisory 27825'
        }
    }),
    ('freshmakerevent', '1180', False, {
        ...
        'meta': {
            'siblings_table_header': 'Advisories triggered by FreshmakerEvent 1180'
        }
    }),
    ('containeradvisory', '12327', False, {
        ...
        'meta': {
            'siblings_table_header': 'ContainerKojiBuilds attached ContainerAdvisory 12327'
        }
    }),
    ('containerkojibuild', '710', True, {
        ...
        'meta': {
            'siblings_table_header': 'ContainerAdvisories attached ContainerKojiBuild 710'
        }
    })
])
